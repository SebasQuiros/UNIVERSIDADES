    ...
    <div className="flex flex-col h-full">
      <div className="p-5 pb-4" style={{ borderBottom: '1px solid rgba(59,130,246,0.15)' }}>
        <Link href="/admin" onClick={() => setOpen(false)} className="flex items-center gap-3 group">
          ...
          <div>
            <h1 className="text-lg font-black tracking-tight leading-none" style={{ color: '#60A5FA' }}>ContaSJ</h1>
            <p className="text-[0.68rem] font-bold uppercase tracking-[0.14em] mt-1" style={{ color: '#FBBF24' }}>
      ...
      <div className="p-3 pb-4">
        <div className="flex items-center gap-3 px-3 py-2.5 mb-2 rounded-xl"
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs truncate" style={{ color: '#60A5FA' }}>{user?.role}</p>
          </div>
        </div>
