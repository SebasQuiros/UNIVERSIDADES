      ...
      {exercise.isPublished && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          {[
            ...
            { label: 'En progreso',   value: stats.inProgress, color: 'text-blue-700' },
                  ...
                  {top.map((a, i) => {
                    ...
                    return (
                      <div key={a.id} className="flex items-center gap-2">
                        ...
                        <span className={`text-xs font-bold ${pct >= 75 ? 'text-emerald-600' : pct >= 50 ? 'text-blue-700' : 'text-gray-500'}`}>{pct}%</span>
                      </div>
                    );
                  })}
                </div>
