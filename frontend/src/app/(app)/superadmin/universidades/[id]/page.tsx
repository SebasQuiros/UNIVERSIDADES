    ...
    <div className="flex-1 p-6 lg:p-8 overflow-y-auto">
      ...
      <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6 mb-6">
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-2 flex-wrap mb-2">
              ...
              {university.plan && (
                <span className="text-xs px-2 py-0.5 rounded-full bg-teal-50 text-teal-700 border border-teal-200 font-medium flex items-center gap-1">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="p-2 rounded-xl border border-gray-200 text-gray-500 hover:text-teal-700 hover:border-teal-200 hover:bg-teal-50 transition-colors"
              title="Editar"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5 pt-5 border-t border-gray-100">
          {[
            { label: 'Cursos',      value: university.stats.totalCourses,   icon: BookOpen,      color: 'text-teal-600',    bg: 'bg-teal-50' },
