...
// ── Ranking empresarial (leaderboard vivo) — spec Multiempresa cap. 9 ──────────
interface RankRow {
...
function SessionLeaderboard({ sessionId, myCompanyId }: { sessionId: string; myCompanyId?: string }) {
          ...
          {rows.map((r) => {
            ...
            return (
              <div key={r.companyId}
                ...
                {mine && (
                  <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 border-t border-gold-100 pt-2 text-[11px] text-gray-500">
