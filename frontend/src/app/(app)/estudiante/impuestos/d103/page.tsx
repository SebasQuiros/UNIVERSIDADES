      ...
      <div className="bg-orange-900 text-white">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/estudiante/impuestos" className="text-orange-300 hover:text-white transition-colors">
              <ArrowLeft className="w-5 h-5" />
            </Link>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold uppercase tracking-widest text-orange-300">Ministerio de Hacienda</span>
                <span className="text-orange-600">|</span>
                <span className="text-xs font-bold uppercase tracking-widest text-orange-300">TRIBU CR</span>
              </div>
              <h1 className="text-lg font-black">D-103 — Retención en la Fuente</h1>
              <p className="text-xs text-orange-300">Declaración mensual de retenciones a proveedores</p>
            </div>
          </div>
          {isSubmitted && (
